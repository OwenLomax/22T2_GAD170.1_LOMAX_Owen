...
public class BattleSystem : MonoBehaviour
{
    private void Start()
    {
        ...
        int playerOnePowerLevel = (playerOneLuck + playerOneStyle + playerOneRhythm);
        int playerTwoPowerLevel = (playerTwoLuck + playerTwoStyle + playerTwoRhythm);

        // Debug out the two players, power levels.
        Debug.Log("Player One's power level is =" + playerOnePowerLevel);
        Debug.Log("Player Two's power level is =" + playerTwoPowerLevel);
        ...
        Debug.Log("Player One has a " + playerOneChanceToWin.ToString("0") + "% chance of winning. Player 2 has a " + playerTwoChanceToWin.ToString("0") + "% chance of winning.");
